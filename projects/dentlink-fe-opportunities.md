...
- 최신 구성은 **업무 목록 표 1개(11개 안·업무/대상/설명/예상 총 작업일) → 참고 도식 2개**입니다. 사용자는 아직 실제 구현 계획이 아니라 아이디어를 다시 고르고 대략 산정하는 단계라며 간결함과 항목 간 일관성을 요청했습니다. 모든 업무의 설명·사용 예를 표에 같은 수준으로 담고, 일부에만 붙였던 별도 설명 4개는 제거했습니다. 도식은 앞서 만든 사진/에디터 참고 자료라고 명시했습니다. 작업일 기준·계산·첫 범위·판단 기준 등 구현 계획 문장을 다시 늘리지 않습니다.
