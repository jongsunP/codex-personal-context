...
- Official local/staging/deployed-dev/headed commands and all three CI workflows
  use one runner for collection, version/source evidence, verdict and artifacts.
