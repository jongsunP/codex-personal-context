...
- 서비스 성격은 Slack처럼 채팅·읽음·알림이 중심인 팀 협업 메신저다. 단순히
  WebSocket을 한 번 사용해본 경험이 아니라, 그러한 실시간 상호작용이 제품의
  핵심인 환경에서 웹을 개발한 경험으로 이해한다. 특정 회사명이나 현재 내부
  기술 스택을 추정하여 기록하려는 취지는 아니다.
